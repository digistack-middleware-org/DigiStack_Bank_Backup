...
<head>
    ...
    <style>
        ...
        .btn-unfreeze:hover { opacity: 0.9; transform: translateY(-1px); color: white; }
        .btn-cancel {
            ...
            font-size: 0.95rem; text-decoration: none; transition: background-color 0.2s;
        }
        ...
        .alert-info-custom {
            background: #e8f4fd; border: 1px solid #90cdf4;
            border-radius: 12px; padding: 14px 18px; color: #1a5276;
            font-size: 0.9rem; display: flex; align-items: flex-start;
            ...
            <div class="col-lg-7">
                ...
                <div class="alert-error-custom">
                    <i class="bi bi-exclamation-circle-fill"
                       style="font-size:1.2rem;flex-shrink:0;"></i>
                    <div><strong>Unfreeze Failed</strong><br><%= error %></div>
                </div>
                <% } %>
                ...
                <%-- ── Not Frozen — show message, not the form ── --%>
                <% if (!frozen) { %>
                <div class="alert-info-custom">
                    ...
                    <div>
                        ...
                        <a href="Freeze" style="color:#1a5276;font-weight:700;">
                            freeze your account
                        </a>.
                    </div>
                </div>

                <%-- ── Frozen — show unfreeze confirmation form ── --%>
                <% } else { %>
                <div class="confirm-card">
                    <div class="confirm-card-title">
                        <i class="bi bi-unlock" style="color:#28a745;"></i>
                        Confirm Unfreeze
                    </div>

                    <p style="font-size:0.9rem;color:#555;margin-bottom:20px;">
                        Unfreezing your account will <strong>immediately restore</strong>
                    ...
                    <form action="Unfreeze" method="post">
                        ...
                        <div class="d-flex gap-3 flex-wrap">
                            <button type="submit" class="btn-unfreeze">
                                <i class="bi bi-unlock me-2"></i>Unfreeze Account
                            </button>
