...
<head>
    ...
    <style>
        ...
        .btn-toggle-balance {
            ...
            font-size: 0.8rem; padding: 5px 14px; border-radius: 6px;
        ...
        .form-label {
            ...
            color: var(--db-navy); margin-bottom: 6px;
        }
        .form-control {
        ...
        .btn-quick-amount:hover {
            background: #e2e8f4; border-color: var(--db-navy);
        }
        /* ── Deposit Button ── */
        .btn-deposit {
    ...
    <div class="container">
        ...
        <div class="alert-error-custom">
            <i class="bi bi-exclamation-circle-fill"
               style="font-size:1.2rem;flex-shrink:0;"></i>
            <div><strong>Deposit Failed</strong><br><%= error %></div>
        </div>
        <% } %>
