    ...
    <header class="db-hero text-center">
        ...
        <div class="container">
            ...
            <h1 class="display-5 fw-bold">
                ...
                Welcome to DigiStack Bank

            </h1>

            <p class="lead mb-0">

                Secure. Reliable. Built on enterprise-grade infrastructure.
                    ...
                    <div class="card-body text-center">
                        ...
                        <% if (request.getAttribute("username") != null) { %>
                            ...
                            <a
                                ...
                                class="btn btn-db btn-sm text-white mb-4 me-2">
                        ...
                        <% } else { %>
                            ...
                            <a
                                ...
                                class="btn btn-db btn-sm text-white mb-4">
                        ...
                        <p class="text-muted small mb-0">
                            ...
                            Live read from PostgreSQL via
                            WebSphere-managed JDBC.
