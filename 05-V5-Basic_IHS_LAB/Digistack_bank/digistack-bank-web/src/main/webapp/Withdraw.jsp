...
<head>
    ...
    <style>
        ...
        .balance-hidden-dots { font-size: 1.8rem; letter-spacing: 6px; color: rgba(255,255,255,0.35); }
        .btn-toggle-balance {
            background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.25);
            color: white; font-size: 0.8rem; padding: 5px 14px;
            border-radius: 6px; cursor: pointer; margin-top: 10px; transition: background-color 0.2s;
        }
        ...
        .form-label { font-weight: 600; font-size: 0.85rem; color: var(--db-navy); margin-bottom: 6px; }
        .form-control {
            border: 1.5px solid #dde3ed; border-radius: 10px;
            padding: 11px 14px; font-size: 0.95rem;
            transition: border-color 0.2s, box-shadow 0.2s;
        }
        .form-control:focus { border-color: var(--db-navy); box-shadow: 0 0 0 3px rgba(11,37,69,0.08); }
        .input-prefix {
            background: var(--db-light-bg); border: 1.5px solid #dde3ed;
            border-right: none; border-radius: 10px 0 0 10px;
            padding: 11px 14px; color: #666; font-weight: 600;
        }
        ...
        .btn-quick-amount {
            ...
            font-weight: 600; color: var(--db-navy); cursor: pointer;
            transition: background-color 0.15s, border-color 0.15s;
        }
        .btn-quick-amount:hover { background: #e2e8f4; border-color: var(--db-navy); }
        .btn-withdraw {
        ...
        .btn-withdraw:hover { opacity: 0.9; transform: translateY(-1px); color: white; }
...
<div class="page-header">
    <div class="container">
        ...
        <h1><i class="bi bi-arrow-up-circle me-2"></i>Withdraw Funds</h1>
    ...
    <div class="container">
        ...
        <div class="alert-error-custom">
            <i class="bi bi-exclamation-circle-fill"
               style="font-size:1.2rem;flex-shrink:0;"></i>
            <div><strong>Withdrawal Failed</strong><br><%= error %></div>
        </div>
        <% } %>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5">
                ...
                <div class="account-summary-card">
                    ...
                    <div id="balHidden" class="balance-hidden-dots">••••••</div>
            ...
            <div class="col-lg-7">
                <div class="form-card">
                    ...
                    <div style="background:#fff3cd;border:1px solid #ffc107;
                                ...
                                color:#856404;font-size:0.88rem;margin-bottom:16px;">
                        <i class="bi bi-lock-fill me-2"></i>
                        Your account is frozen. Withdrawals are blocked.
                    ...
                    <form action="Withdraw" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="quick-amounts">
                                <button type="button" class="btn-quick-amount"
                                        onclick="setAmt(500)">₹500</button>
                                <button type="button" class="btn-quick-amount"
                                        onclick="setAmt(1000)">₹1,000</button>
                                <button type="button" class="btn-quick-amount"
                                        onclick="setAmt(5000)">₹5,000</button>
                                <button type="button" class="btn-quick-amount"
                                        onclick="setAmt(10000)">₹10,000</button>
                            </div>
                        </div>
...
<script>
    ...
    function toggleBal() {
        ...
        if (balShown) {
            ...
            b.innerHTML = '<i class="bi bi-eye-slash me-1"></i>Hide Balance';
        } else {
            h.style.display = 'block'; v.style.display = 'none';
            b.innerHTML = '<i class="bi bi-eye me-1"></i>View Balance';
        }
    }
    function setAmt(v) {
